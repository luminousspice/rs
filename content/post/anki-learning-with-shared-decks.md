...
<h3 id="プレビュー時の確認項目">プレビュー時の確認項目</h3>
...
<h3 id="ブラウザーのプレビュー機能の使い方">ブラウザーのプレビュー機能の使い方</h3>
...
<h3 id="ブラウザーの一覧表示を使った確認">ブラウザーの一覧表示を使った確認</h3>
...
表示中のカードを編集したい時は、画面上の [Edit] を選択します。</p>
<div class="imageblock">
<div class="content">
