...
<h3 id="ankimobile_について">AnkiMobile について</h3>
...
この機能によって一枚一枚の記憶内容の強化と、カード全体の進捗管理が効率的にできます。</p>
...
<h3 id="ios_アプリ版の位置づけ">iOS アプリ版の位置づけ</h3>
...
<h3 id="この記事の構成">この記事の構成</h3>
<p>PC 版 Anki についてはすでに、<a href="/how-to-anki/">Ankiの使い方 〜覚えるために忘れろ〜</a>という連載記事で利用するのに必要な最低限の情報を網羅しています。
...
<div class="imageblock">
<div class="content">
<img src="/images/how-to-ankimobile-editscreen.png" alt="編集画面" width="300" height="450">
</div>
...
<h3 id="ankiweb_のオンラインストレージによる同期">AnkiWeb のオンラインストレージによる同期</h3>
...
<h3 id="itunes_ファイル共有機能による入出力">iTunes ファイル共有機能による入出力</h3>
...
<h4 id="ankimobile_側の手順">AnkiMobile 側の手順</h4>
...
<h4 id="pc_上の_itunes_側の手順">PC 上の iTunes 側の手順</h4>
...
<a href="/ankimobile-survival-guide/">iPhone ユーザーのための AnkiMobile サバイバルガイド</a>のデータ入出力、共有単語帳のインストール手順を説明しています。</p>
<p>なお AnkiMobile では、Anki PC 版のアドオンプログラムは利用できません。</p>
<h3 id="共有単語帳の作成">共有単語帳の作成</h3>
...
<div class="imageblock">
<div class="content">
<img src="/images/how-to-ankimobile-type-answer.png" alt="AnkiMobile 上の解答キー入力" width="300" height="450">
</div>
...
<h3 id="カスタム学習セッションの作成">カスタム学習セッションの作成</h3>
<p>カスタム学習では、単語帳オプションで指定している学習上限を一時的に緩めて、新たな学習カードを取得します。</p>
<p>カスタム学習セッションは、[Tools] - [More] - [Custom Study] で設定画面を呼び出して始めます。</p>
<div class="imageblock">
<div class="content">
<img src="/images/how-to-ankimobile-customstudy.png" alt="カスタム学習" width="300" height="450">
</div>
...
<h3 id="フィルター単語帳の作成">フィルター単語帳の作成</h3>
...
<div class="title">図 11. フィルター単語帳設定画面</div>
</div>
...
<h3 id="カスタム学習セッション_フィルター単語帳のアクション">カスタム学習セッション、フィルター単語帳のアクション</h3>
...
<h3 id="カスタム学習セッション_フィルター単語帳の削除">カスタム学習セッション、フィルター単語帳の削除</h3>
...
<h3 id="学習オプション">学習オプション</h3>
<p>AnkiMobile 上では、単語帳の学習オプションとして一日の新規カードの上限と復習の上限が設定できます。
学習画面から [Tools] - [Study Options] で設定画面を呼び出せます。</p>
<div class="imageblock">
<div class="content">
<img src="/images/how-to-ankimobile-studyoption.png" alt="学習オプション" width="300" height="450">
</div>
...
<h3 id="テーマファイルの設定">テーマファイルの設定</h3>
...
<h3 id="テキストを読み上げる">テキストを読み上げる</h3>
