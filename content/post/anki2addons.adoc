...
lastmod: "2017-08-15T11:32:51+00:00"
...
この文書は、link:http://ankisrs.net/docs/addons.html[Writing Anki 2.x Add-ons] 2017-08-15 版の日本語訳です。

Anki 2.x は 2017 年 8 月 15 日現在、最新バージョンは 2.0.46 および 2.1 Beta 11 です。より最新で正確な情報をご覧になりたい方は、原本をご覧ください。
...
* Anki 2.0.x は、link:http://doc.qt.io/qt-4.8/index.html[Qt 4.8] を使っています。
* Anki 2.1.x は、link:http://doc.qt.io/qt-5/index.html[Qt 5.9] を使っています。
